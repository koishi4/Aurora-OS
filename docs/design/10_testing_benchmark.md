...
- USER_TEST=1 make test-qemu-smoke (验证最小用户态 ecall 路径，覆盖 getdents64(/,/dev)、FAT32 文件写入回读、openat O_CREAT|O_EXCL、/dev/null write、ppoll 多 fd sleep-retry 超时、poll/pipe 就绪、futex cleartid 唤醒与 timeout、wait4 与 execve ELF 加载)
