...
const USER_DIRENT_BUF_LEN: usize = 1536;
const USER_STR_BASE_VA: usize = USER_STACK_VA + 0x100;
const USER_DIR_PATH_VA: usize = USER_STR_BASE_VA + 0x00;
const USER_DIR_DEV_VA: usize = USER_STR_BASE_VA + 0x08;
const USER_DEVNULL_PATH_VA: usize = USER_STR_BASE_VA + 0x20;
const USER_DEVNULL_MSG_VA: usize = USER_STR_BASE_VA + 0x40;
const USER_FAT32_PATH_VA: usize = USER_STR_BASE_VA + 0x60;
const USER_FAT32_MSG_VA: usize = USER_STR_BASE_VA + 0x80;
const USER_FAT32_BUF_VA: usize = USER_DATA_VA + 0x800;
const USER_FAT32_BUF_LEN: usize = 1024;
const USER_CREAT_PATH_VA: usize = USER_STR_BASE_VA + 0x5A0;
const USER_CREAT_MSG_VA: usize = USER_STR_BASE_VA + 0x5C0;
const USER_CREAT_FAIL_VA: usize = USER_STR_BASE_VA + 0x5E0;
...
const USER_FAT32_BUF_INIT: [u8; USER_FAT32_BUF_LEN] = [b'F'; USER_FAT32_BUF_LEN];
const USER_CREAT_PATH: &[u8] = b"/new.txt\0";
const USER_CREAT_MSG: &[u8] = b"creat: ok\n";
const USER_CREAT_MSG_LEN: usize = USER_CREAT_MSG.len();
const USER_CREAT_FAIL: &[u8] = b"creat: fail\n";
const USER_CREAT_FAIL_LEN: usize = USER_CREAT_FAIL.len();
...
//   openat(O_CREAT|O_EXCL) -> 覆盖 FAT32 文件创建与 EEXIST 路径
...
const USER_CODE: [u8; 1236] = [    ,];
...
pub fn restore_user_test_paths(root_pa: usize) {
    if !config::ENABLE_USER_TEST {
        return;
    }
    let entries: &[(usize, &[u8])] = &[
        (USER_DIR_PATH_VA, USER_DIR_ROOT_PATH),
        (USER_DIR_DEV_VA, USER_DIR_DEV_PATH),
        (USER_DEVNULL_PATH_VA, USER_DEVNULL_PATH),
        (USER_DEVNULL_MSG_VA, USER_DEVNULL_MSG),
        (USER_FAT32_PATH_VA, USER_FAT32_PATH),
        (USER_FAT32_MSG_VA, USER_FAT32_MSG),
        (USER_CREAT_PATH_VA, USER_CREAT_PATH),
        (USER_CREAT_MSG_VA, USER_CREAT_MSG),
        (USER_CREAT_FAIL_VA, USER_CREAT_FAIL),
    ];
    for (addr, bytes) in entries {
        let _ = mm::UserSlice::new(*addr, bytes.len()).copy_from_slice(root_pa, bytes);
    }
    let _ = mm::UserSlice::new(USER_FAT32_BUF_VA, USER_FAT32_BUF_LEN)
        .copy_from_slice(root_pa, &USER_FAT32_BUF_INIT);
}
...
pub fn load_user_image(root_pa: usize) -> Option<UserContext> {
    ...
    if config::ENABLE_USER_TEST {
        let data_map = mm::translate_user_ptr(root_pa, USER_DATA_VA, 1, mm::UserAccess::Write)
            .unwrap_or(0);
        let stack_map = mm::translate_user_ptr(root_pa, USER_STACK_VA, 1, mm::UserAccess::Write)
            .unwrap_or(0);
        crate::println!(
            "user-test: pages code={:#x} data={:#x} stack={:#x} map[data]={:#x} map[stack]={:#x}",
            code_pa,
            data_pa,
            stack_pa,
            data_map,
...
fn init_user_image(code_pa: usize, data_pa: usize, stack_pa: usize) {
    ...
    unsafe {
        ...
        let creat_path_base = stack_pa + (USER_CREAT_PATH_VA - USER_STACK_VA);
        ptr::copy_nonoverlapping(
            USER_CREAT_PATH.as_ptr(),
            creat_path_base as *mut u8,
            USER_CREAT_PATH.len(),
        );
        let creat_msg_base = stack_pa + (USER_CREAT_MSG_VA - USER_STACK_VA);
        ptr::copy_nonoverlapping(
            USER_CREAT_MSG.as_ptr(),
            creat_msg_base as *mut u8,
            USER_CREAT_MSG.len(),
        );
        let creat_fail_base = stack_pa + (USER_CREAT_FAIL_VA - USER_STACK_VA);
        ptr::copy_nonoverlapping(
            USER_CREAT_FAIL.as_ptr(),
            creat_fail_base as *mut u8,
            USER_CREAT_FAIL.len(),
        );
        if config::ENABLE_USER_TEST {
            let mut devnull_check = [0u8; 12];
            let mut fat32_check = [0u8; 12];
            let mut creat_check = [0u8; 12];
            ptr::copy_nonoverlapping(
                devnull_path_base as *const u8,
                devnull_check.as_mut_ptr(),
                devnull_check.len(),
            );
            ptr::copy_nonoverlapping(
                fat32_path_base as *const u8,
                fat32_check.as_mut_ptr(),
                fat32_check.len(),
            );
            ptr::copy_nonoverlapping(
                creat_path_base as *const u8,
                creat_check.as_mut_ptr(),
                creat_check.len(),
            );
            crate::println!(
                "user-test: init paths devnull={:?} fat32={:?} creat={:?}",
                devnull_check,
                fat32_check,
                creat_check
            );
